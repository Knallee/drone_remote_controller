...
#define TWI_BITRATE 400       //TWI_BITRATE in kHz
...
void TWI_Start_Transceiver_With_Data(uint8_t, uint8_t *, uint8_t);
...
extern uint8_t readFlag;	  // set to 1 when read
extern uint8_t MPUFlag;		  // set to 1 when reading MPU data
